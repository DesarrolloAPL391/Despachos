...
function renderCumplimiento(agg, fecha) {
  ...
  const chartHora = `<div class="cump-card"><h4>Cobertura por hora</h4><div class="cbar-wrap">${barsHora}</div>`
    + `<div class="cump-leg"><span class="lg desp">✓ Completo</span><span class="lg inc">◐ Incompleto</span><span class="lg curso">● En curso</span><span class="lg perd">✕ Perdido</span><span class="lg sin">○ Sin despachar</span></div></div>`;
