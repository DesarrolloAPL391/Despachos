...
const NOVEDADES = [
  'PESCA', 'TALLER', 'NO MADRUGA', 'SIN INFORMACION', 'REEMPLAZA OTRO VEHICULO', 'SIN CONDUCTOR', 'ERROR DESPACHADOR', 'CAMBIO DE TABLA', 'CAMBIO DE RUTA', 'SUSPENDIDO',
  'REQUERIMIENTO EMPRESA', 'VACACIONES', 'CONDUCTOR EN OTRA RUTA', 'CONDUCTOR EN OTRO VEHICULO',
  'INCAPACIDAD EPS', 'CITA MEDICA EPS', 'RESTRICCION MEDICA', 'RESTRICCION OPERACIONAL', 'CDA', 'ADELANTADO', 'ABANDONA EL SERVICIO', 'CONGESTION VEHICULAR',
];
